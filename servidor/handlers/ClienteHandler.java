            ...
            while ((msg = in.readLine()) != null) {
                ...
                if (msg.startsWith("LOGIN_DOCENTE")) {
                    ...
                    try {
                        ...
                        if (pd == null) { out.println("ERRO:CODIGO_INVALIDO"); continue; }
                        if (!"ATIVA".equals(pd.estado)) { out.println("ERRO:PERGUNTA_NAO_ATIVA"); continue; }
                        if (pd.opcoes.size() < 2) { out.println("ERRO:PERGUNTA_INCOMPLETA"); continue; }
